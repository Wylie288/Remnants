...
if (argument4 == 1) 
{
    ...
    for (global.lista = global.listc; global.lista<global.draw; global.lista+=2;) //<< Notice we are incrimenting by 2 to only get the EVEN lines
    {
        ...
        global.listb = global.lista+1;
            ...
            if (argument5 == 1)//5
            {
                if global.uname = ds_list_find_value(name_list,global.lista) && record = real(ds_list_find_value(name_list,global.listb))
                ...
                if (argument6 == 1)//6
                {
                    ...
                    else
                    {
                        ...
                        draw_text(argument0+32,skip,ds_list_find_value(name_list,global.lista));//Loop through all the EVEN indexes for the names only
