...
switch(argument4)
    {
    case 5: gsTable1_noScroll(argument0,argument1,argument2,argument3,argument4,argument5,argument6); break;
    ...
    case 1: gsTable1_Scroll_friends(argument0,argument1,argument2,argument3,argument4,argument5,argument6); break; 
